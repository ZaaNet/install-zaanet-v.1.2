...
# Hard reset Nodogsplash config for v5/v6 compatibility (BEFORE deploying files)
...
# NOTE: Removed --force-reinstall to avoid overwriting deployed files
# The package is already installed from Step 6
print_success "Nodogsplash configuration reset (preserving deployed files)"
